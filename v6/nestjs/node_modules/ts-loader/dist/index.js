...
const loaderUtils = __importStar(require("./loaderUtils"));
 ...
 */
const canUseSourceMapConsumer = typeof source_map_1.SourceMapConsumer === 'function' &&
    typeof source_map_1.SourceMapConsumer.prototype === 'object' &&
    typeof source_map_1.SourceMapConsumer.prototype.destroy === 'function';
...
function makeLoaderOptions(instanceName, loaderOptions, loaderContext) {
    var _a, _b, _c;
    const hasForkTsCheckerWebpackPlugin = (_c = (_b = (_a = loaderContext._compiler) === null || _a === void 0 ? void 0 : _a.options.plugins) === null || _b === void 0 ? void 0 : _b.some(plugin => {
        var _a;
        return plugin !== null &&
