...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "prefix" | "guildSettings"
    ...
    model: {
      ...
      GuildSettings: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.GuildSettingsFindRawArgs<ExtArgs>
            result: JsonObject
          }
          aggregateRaw: {
            args: Prisma.GuildSettingsAggregateRawArgs<ExtArgs>
            result: JsonObject
          }
          count: {
  ...
  export type GuildSettingsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "guildId" | "guildName" | "ownerId" | "musicChannelId" | "createdAt" | "updatedAt", ExtArgs["result"]["guildSettings"]>
  ...
  export interface GuildSettingsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    ...
    /**
     * Find zero or more GuildSettings that matches the filter.
     * @param {GuildSettingsFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const guildSettings = await prisma.guildSettings.findRaw({
     *   filter: { age: { $gt: 25 } }
     * })
     */
    findRaw(args?: GuildSettingsFindRawArgs): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a GuildSettings.
     * @param {GuildSettingsAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const guildSettings = await prisma.guildSettings.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
     * })
     */
    aggregateRaw(args?: GuildSettingsAggregateRawArgs): Prisma.PrismaPromise<JsonObject>
  ...
  interface GuildSettingsFieldRefs {
    ...
    readonly guildName: FieldRef<"GuildSettings", 'String'>
    readonly ownerId: FieldRef<"GuildSettings", 'String'>
    readonly musicChannelId: FieldRef<"GuildSettings", 'String'>
  ...
  /**
   * GuildSettings findRaw
   */
  export type GuildSettingsFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
  ...
  /**
   * GuildSettings aggregateRaw
   */
  export type GuildSettingsAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type GuildSettingsWhereInput = {
    ...
    guildName?: StringNullableFilter<"GuildSettings"> | string | null
    ownerId?: StringFilter<"GuildSettings"> | string
    musicChannelId?: StringNullableFilter<"GuildSettings"> | string | null
  ...
  export type GuildSettingsScalarWhereWithAggregatesInput = {
    ...
    guildName?: StringNullableWithAggregatesFilter<"GuildSettings"> | string | null
    ownerId?: StringWithAggregatesFilter<"GuildSettings"> | string
    musicChannelId?: StringNullableWithAggregatesFilter<"GuildSettings"> | string | null
  ...
  export type GuildSettingsUpdateInput = {
    ...
    musicChannelId?: NullableStringFieldUpdateOperationsInput | string | null
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
    updatedAt?: DateTimeFieldUpdateOperationsInput | Date | string
  }
